...
// FlagSet is a facade of pflag.FlagSet, as gfi requires all flag add calls to use field references
...
//
// WARNING: only use this when the gfi API does not provide a necessary feature, such as marking a flag as deprecated.
